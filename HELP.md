...
Hibernate will create the tables in the database and establish the relations
described in the model with the annotations.

# Run the application 
Open a browser using localhost:8080
